        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_UP:
                if (checkOverlap((ImageButton) v)) {
                    ...
                    PopupWindow popupWindow = new PopupWindow(stage5.this);

                    // Inflate the new layout
                    LayoutInflater inflater = LayoutInflater.from(stage5.this);
                    View newLayout = inflater.inflate(R.layout.progress_menu_5, null);
